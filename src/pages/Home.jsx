  ...
  return (
    <div ref={containerRef} className="w-full h-[100dvh] overflow-hidden pointer-events-auto bg-[#F5F2EA] relative perspective-[1000px]">
      ...
      >
        ...
        <div className="absolute left-6 md:left-[8vw] top-[130px] md:top-[20%] lg:top-[45%] lg:-translate-y-1/2 z-30 max-w-[280px] sm:max-w-xl text-left pointer-events-none flex flex-col items-start">
